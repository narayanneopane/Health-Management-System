...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2"
                    DataTextField="Patientname" DataValueField="Patientname">
                    <asp:ListItem>Select</asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:patientmonitoring %>"
                    SelectCommand="SELECT [Patientname] FROM [PatientDetail]"></asp:SqlDataSource>
            </td>
            <td colspan="2">
        ...
        <tr><td>
            ...
            <asp:TextBox ID="txtheartbeat" runat="server"></asp:TextBox></td></tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="3">
                <asp:Chart ID="Chart1" runat="server" Width="716px">
                    ...
                    <Series>
                        <asp:Series Name="Temperature" ChartType="Line" BorderWidth="4"/>
                        <asp:Series Name="Pulse" ChartType="Line" BorderWidth="4"/>
                    </Series>
                    <ChartAreas>
