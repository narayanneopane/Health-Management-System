...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd1 = new SqlCommand("select top 5 Time,Temperature from [Temperature] where [name]='" + DropDownList1.Text + "' ", con);
        ...
        con.Open();
        SqlCommand cmd2 = new SqlCommand("select top 5 Time,heartbeat from [heartbeat] where [name]='" + DropDownList1.Text + "' ", con);
