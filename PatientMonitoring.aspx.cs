...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand da1 = new SqlCommand("SELECT * FROM [Temperature] where name='" + DropDownList1.Text + "'", con);
        ...
        con.Open();
        SqlCommand da = new SqlCommand("select top 5 Temperature from [Temperature] where [name]='" + DropDownList1.Text + "' ", con);
        ...
        con.Open();
        SqlCommand cmd1 = new SqlCommand("select top 5 name,Temperature from [Temperature] where [name]='" + DropDownList1.Text + "' ", con);
        ...
        con.Open();
        SqlCommand da12 = new SqlCommand("select top 5 heartbeat from [heartbeat] where [name]='" + DropDownList1.Text + "' ", con);
        ...
        con.Open();
        SqlCommand cmd2 = new SqlCommand("select top 5 name,heartbeat from [heartbeat] where [name]='" + DropDownList1.Text + "' ", con);
